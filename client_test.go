...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Projects.Get(context.Background(), "projectName")
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Projects.Get(context.Background(), "projectName")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Projects.Get(cancelCtx, "projectName")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Projects.Get(deadlineCtx, "projectName")
		if err == nil {
